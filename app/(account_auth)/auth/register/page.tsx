...
function Page() {
    return (
        <div className='flex flex-wrap relative items-center max-lg:justify-center overflow-x-hidden h-screen mx-auto'>
            ...
            <div className="flex absolute items-center overscroll-y-contain bg-white z-20 lg:right-0 rounded-xl w-full max-w-sm md:max-w-2xl shadow-2xl md:mx-8 flex-1 flex-col justify-center md:py-10 md:my-0 my-4 pb-10 max-[380px]:mt-64">
